...
import com.pufferfishscheduler.master.collect.trans.plugin.service.TableOutputPluginService;
...
public class TableOutputPluginController {

    @Autowired
    private TableOutputPluginService tableOutputPluginService;
    ...
    public ApiResponse getFieldStream(@RequestBody @Valid FieldStreamForm form) {
        return ApiResponse.success(tableOutputPluginService.getFieldStream(form));
    }
}
