package com.pufferfishscheduler.master.database.metadata.controller;
 ...
 */
@Tag(name = OpenApiTags.METADATA, description = OpenApiTags.METADATA_DESC)
@Validated
@RestController
...
public class MetaDataController {
     ...
     * @return
     */
    @Operation(summary = "立即同步数据")
    @PostMapping("/immediatelySync.do")
    public ApiResponse immediatelySync(@RequestParam Integer dbId) {
        metaDataService.immediatelySync(dbId);
