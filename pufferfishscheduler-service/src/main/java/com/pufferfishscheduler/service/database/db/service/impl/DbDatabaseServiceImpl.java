...
import com.pufferfishscheduler.service.database.db.connector.ftp.FTPConnectorFactory;
import com.pufferfishscheduler.service.database.db.connector.relationdb.AbstractDatabaseConnector;
import com.pufferfishscheduler.service.database.db.connector.relationdb.DatabaseConnectorFactory;
...
public class DbDatabaseServiceImpl extends ServiceImpl<DbDatabaseMapper, DbDatabase> implements DbDatabaseService {
     ...
     */
    @Override
    public List<DbDatabase> listDatabasesByGroupIds(Set<Integer> groupIds) {
