package com.pufferfishscheduler.worker.metadata.service;
...
import com.pufferfishscheduler.worker.metadata.connect.AbstractDatabaseConnector;
import com.pufferfishscheduler.worker.metadata.connect.DatabaseConnectorFactory;
...
public class DbSyncExecutor {
    ...
    public DbSyncExecutor(DbDatabaseMapper dbDatabaseMapper,
                          DbTableMapper dbTableMapper,
                          DbFieldMapper dbFieldMapper,
                          DbTablePropertiesMapper dbTablePropertiesMapper,
                          AESUtil aesUtil) {
        this.dbDatabaseMapper = dbDatabaseMapper;
        this.dbTableMapper = dbTableMapper;
        this.dbFieldMapper = dbFieldMapper;
        this.dbTablePropertiesMapper = dbTablePropertiesMapper;
